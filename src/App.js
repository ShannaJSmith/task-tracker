...
const App = () => {
    ...
    const fetchTask = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const reminder = (id) => __awaiter(void 0, void 0, void 0, function* () {
        const taskToggle = yield fetchTask(id);
        const updateTask = Object.assign(Object.assign({}, taskToggle), { reminder: !taskToggle.reminder });
        const res = yield fetch(`http://localhost:5000/tasks/${id}`, {
            method: 'PUT',
            headers: {
                'Content-type': 'application/json'
    ...
    return (<div className="container">
      ...
      {tasks.length > 0 ? (<Tasks_1.default tasks={tasks} onDelete={deleteTask} reminder={reminder}/>) : ('Looks like you have nothing more to do. Nice!')}
    </div>);
};
exports.default = App;
